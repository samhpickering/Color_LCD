...
static Field torqueSensorMenus[] =
    {
            ...
            FIELD_EDITABLE_UINT(_S("Left weight 1", "L weight 1"), &ui_vars.ui16_torque_sensor_calibration_table_left[0][0], "kg", 0, 2000, .div_digits = 1, .inc_step = 10, .hide_fraction = true),
            FIELD_EDITABLE_UINT("Left ADC 1", &ui_vars.ui16_torque_sensor_calibration_table_left[0][1], "", 0, 1023),
            FIELD_EDITABLE_UINT(_S("Left weight 2", "L weight 2"), &ui_vars.ui16_torque_sensor_calibration_table_left[1][0], "kg", 0, 2000, .div_digits = 1, .inc_step = 10, .hide_fraction = true),
            FIELD_EDITABLE_UINT("Left ADC 2", &ui_vars.ui16_torque_sensor_calibration_table_left[1][1], "", 0, 1023),
            FIELD_EDITABLE_UINT(_S("Left weight 3", "L weight 3"), &ui_vars.ui16_torque_sensor_calibration_table_left[2][0], "kg", 0, 2000, .div_digits = 1, .inc_step = 10, .hide_fraction = true),
            FIELD_EDITABLE_UINT("Left ADC 3", &ui_vars.ui16_torque_sensor_calibration_table_left[2][1], "", 0, 1023),
            FIELD_EDITABLE_UINT(_S("Left weight 4", "L weight 4"), &ui_vars.ui16_torque_sensor_calibration_table_left[3][0], "kg", 0, 2000, .div_digits = 1, .inc_step = 10, .hide_fraction = true),
            FIELD_EDITABLE_UINT("Left ADC 4", &ui_vars.ui16_torque_sensor_calibration_table_left[3][1], "", 0, 1023),
            FIELD_EDITABLE_UINT(_S("Left weight 5", "L weight 5"), &ui_vars.ui16_torque_sensor_calibration_table_left[4][0], "kg", 0, 2000, .div_digits = 1, .inc_step = 10, .hide_fraction = true),
            FIELD_EDITABLE_UINT("Left ADC 5", &ui_vars.ui16_torque_sensor_calibration_table_left[4][1], "", 0, 1023),
            FIELD_EDITABLE_UINT(_S("Left weight 6", "L weight 6"), &ui_vars.ui16_torque_sensor_calibration_table_left[5][0], "kg", 0, 2000, .div_digits = 1, .inc_step = 10, .hide_fraction = true),
            FIELD_EDITABLE_UINT("Left ADC 6", &ui_vars.ui16_torque_sensor_calibration_table_left[5][1], "", 0, 1023),
            FIELD_EDITABLE_UINT(_S("Left weight 7", "L weight 7"), &ui_vars.ui16_torque_sensor_calibration_table_left[6][0], "kg", 0, 2000, .div_digits = 1, .inc_step = 10, .hide_fraction = true),
            FIELD_EDITABLE_UINT("Left ADC 7", &ui_vars.ui16_torque_sensor_calibration_table_left[6][1], "", 0, 1023),
            FIELD_EDITABLE_UINT(_S("Left weight 8", "L weight 8"), &ui_vars.ui16_torque_sensor_calibration_table_left[7][0], "kg", 0, 2000, .div_digits = 1, .inc_step = 10, .hide_fraction = true),
            FIELD_EDITABLE_UINT("Left ADC 8", &ui_vars.ui16_torque_sensor_calibration_table_left[7][1], "", 0, 1023),
            FIELD_EDITABLE_UINT(_S("Right weight 1", "R weight 1"), &ui_vars.ui16_torque_sensor_calibration_table_right[0][0], "kg", 0, 2000, .div_digits = 1, .inc_step = 10, .hide_fraction = true),
            FIELD_EDITABLE_UINT("Right ADC 1", &ui_vars.ui16_torque_sensor_calibration_table_right[0][1], "", 0, 1023),
            FIELD_EDITABLE_UINT(_S("Right weight 2", "R weight 2"), &ui_vars.ui16_torque_sensor_calibration_table_right[1][0], "kg", 0, 2000, .div_digits = 1, .inc_step = 10, .hide_fraction = true),
            FIELD_EDITABLE_UINT("Right ADC 2", &ui_vars.ui16_torque_sensor_calibration_table_right[1][1], "", 0, 1023),
            FIELD_EDITABLE_UINT(_S("Right weight 3", "R weight 3"), &ui_vars.ui16_torque_sensor_calibration_table_right[2][0], "kg", 0, 2000, .div_digits = 1, .inc_step = 10, .hide_fraction = true),
            FIELD_EDITABLE_UINT("Right ADC 3", &ui_vars.ui16_torque_sensor_calibration_table_right[2][1], "", 0, 1023),
            FIELD_EDITABLE_UINT(_S("Right weight 4", "R weight 4"), &ui_vars.ui16_torque_sensor_calibration_table_right[3][0], "kg", 0, 2000, .div_digits = 1, .inc_step = 10, .hide_fraction = true),
            FIELD_EDITABLE_UINT("Right ADC 4", &ui_vars.ui16_torque_sensor_calibration_table_right[3][1], "", 0, 1023),
            FIELD_EDITABLE_UINT(_S("Right weight 5", "R weight 5"), &ui_vars.ui16_torque_sensor_calibration_table_right[4][0], "kg", 0, 2000, .div_digits = 1, .inc_step = 10, .hide_fraction = true),
            FIELD_EDITABLE_UINT("Right ADC 5", &ui_vars.ui16_torque_sensor_calibration_table_right[4][1], "", 0, 1023),
            FIELD_EDITABLE_UINT(_S("Right weight 6", "R weight 6"), &ui_vars.ui16_torque_sensor_calibration_table_right[5][0], "kg", 0, 2000, .div_digits = 1, .inc_step = 10, .hide_fraction = true),
            FIELD_EDITABLE_UINT("Right ADC 6", &ui_vars.ui16_torque_sensor_calibration_table_right[5][1], "", 0, 1023),
            FIELD_EDITABLE_UINT(_S("Right weight 7", "R weight 7"), &ui_vars.ui16_torque_sensor_calibration_table_right[6][0], "kg", 0, 2000, .div_digits = 1, .inc_step = 10, .hide_fraction = true),
            FIELD_EDITABLE_UINT("Right ADC 7", &ui_vars.ui16_torque_sensor_calibration_table_right[6][1], "", 0, 1023),
            FIELD_EDITABLE_UINT(_S("Right weight 8", "R weight 8"), &ui_vars.ui16_torque_sensor_calibration_table_right[7][0], "kg", 0, 2000, .div_digits = 1, .inc_step = 10, .hide_fraction = true),
...
static Field technicalMenus[] = {
  ...
  FIELD_READONLY_UINT(_S("Weight with offset", "Weight off"), &ui_vars.ui16_pedal_weight_with_offset, "kg", .div_digits = 1, .hide_fraction = true),
  FIELD_READONLY_UINT(_S("Weight without offset", "Weight"), &ui_vars.ui16_pedal_weight, "kg", .div_digits = 1, .hide_fraction = true),
