...
static Field torqueSensorMenus[] =
    {
            ...
            FIELD_READONLY_UINT(_S("Left weight 1", "L weight 1"), &ui_vars.ui16_torque_sensor_calibration_table_left[0][0], ""),
            ...
            FIELD_READONLY_UINT(_S("Right weight 1", "R weight 1"), &ui_vars.ui16_torque_sensor_calibration_table_right[0][0], ""),
